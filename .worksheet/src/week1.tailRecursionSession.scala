...
object tailRecursionSession {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(121); 

 def factorial(n: Double): Double =
  	if(n == 0) 1 else n * factorial(n-1);System.out.println("""factorial: (n: Double)Double""");$skip(277); 
  ...
  };System.out.println("""tailFactorial: (n: Double)Double""");$skip(18); val res$0 = 
